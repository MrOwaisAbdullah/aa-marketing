...
export async function sendContactFormEmail(formData: FormData) {
  ...
  const sendSmtpEmail = {
    ...
    to: [{ email: "dsumerfarooq@gmail.com" }],
  ...
  const confirmationEmail = {
    sender: { name: "AA Marketing", email: "info@aamarktng.com" },
    to: [{ email }],
    subject: "Thank You for Contacting AA Marketing",
    htmlContent: `
      <p>Dear ${name},</p>
      <p>Thank you for reaching out to us! We have received your message and will get back to you soon.</p>
      <p><strong>Your Message:</strong> ${message}</p>
      <p>Best regards,<br>AA Marketing Team</p>
    `,
  };
