...
export default function ServiceCard({ image, description, link, buttonText="Read More" }: ServiceCardProps) {
  ...
  return (
    <Card
      className="font-poppins group overflow-hidden border border-border hover:border-border-primary bg-background text-text transition-all duration-300 hover:shadow-lg hover:shadow-primary/20"
