    ...
    <div className="mb-6">
      <div className="bg-white rounded-lg shadow-2xl overflow-hidden w-48 h-36 lg:w-72 lg:h-52 border border-gray-200">
        ...
        <div className={`${card.color} h-full relative overflow-hidden`}>
          ...
          {/* Header */}
          <div
            className="bg-white/90 mx-2 mt-1.5 rounded px-2 py-1"
            style={{
          ...
          >
            <div className="h-1.5 bg-gray-300 rounded mb-1" />
          ...
          <div className="absolute bottom-1.5 left-2">
            <div className="bg-white/90 rounded px-2 py-0.5 text-xs font-medium">
              {card.title}
            </div>
          </div>
        </div>
