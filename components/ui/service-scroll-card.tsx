...
const ServiceCard = ({ service, index }: ServiceCardProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Animated border */}
      <div className="absolute inset-0 rounded-2xl border-2 border-transparent bg-gradient-to-br to-white via-primary from-accent opacity-0 group-hover:opacity-50 transition-opacity duration-500" 
           style={{ 
             background: 'linear-gradient(40deg, transparent, accent, indigo, transparent)',
