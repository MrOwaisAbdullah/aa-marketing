      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-1/2">
            <FadeInSection>
              <h2 className="text-3xl md:text-4xl font-bold mb-10 font-montserrat text-text">
                {mainTitle} <span className="text-primary">{titleName}</span> for {titleFor}?
              </h2>
          ...
          <div className="lg:w-1/2">
            <FadeInSection delay={0.3}>
              <div className="bg-secondary p-8 rounded-lg border border-border shadow-lg shadow-primary/20">
                <h3 className="text-2xl font-bold mb-6 font-montserrat text-text">Features</h3>
