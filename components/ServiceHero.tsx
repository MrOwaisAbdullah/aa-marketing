...
export default function ServiceHeroSection({
  ...
  return (
    <section className="relative bg-gradient-to-t from-[#6a59ee] to-transparent backdrop-blur-sm overflow-hidden md:pt-24 pt-16 pb-20 rounded-b-[50px] border-b border-b-border">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
        <motion.div
          className="absolute bottom-[10%] left-[5%] w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-purple-600/20 via-primary to-transparent blur-[80px] opacity-40"
        ...
        {/* <motion.div
          className="absolute bottom-[40%] right-[40%] w-12 h-12 border-2 border-primary/25 rounded-full"
      ...
      <div
        className="absolute -top-48 inset-0 w-full h-full min-h-screen blur-[2px] pointer-events-none"
        style={{
      ...
      ></div>
        <FadeInSection>
          <div className="text-center mb-8">
            <span className="text-primary uppercase tracking-wider text-sm font-bold font-montserrat">
              {subheading}
            </span>
          </div>
          <h1 className="text-4xl text-black/70 md:text-5xl md:leading-tight font-bold text-center mb-6 font-montserrat">
