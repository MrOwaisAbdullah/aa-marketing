    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects[service].map((project: Project, index: number) => (
          <div
            key={index}
            className="group entrance scroll-smooth border border-border rounded-lg overflow-hidden hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-[#dc5b5b]/20 bg-background"
          >
