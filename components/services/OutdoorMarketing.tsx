        ...
        <div className="px-4">
          <FadeInSection>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-montserrat text-text">
              Real-World Reach with{" "}
              <span className="text-primary">Outdoor Campaigns</span> That Work
            </h2>
            <p className="text-text/80 mb-16 max-w-3xl text-lg font-poppins">
              We help you take your brand beyond the screen - into
              neighborhoods, roadsides, markets, and transit routes. Our outdoor
              marketing connects you with people where they live, shop, and
              move.
            </p>
          </FadeInSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <FadeInSection delay={0.6}>
              <ServiceCard
                icon={CalendarCog}
                title="Event & Launch Branding"
                description="We provide complete outdoor branding solutions for product launches, store openings, and events — from banners to road branding and everything in between."
              />
            </FadeInSection>
      ...
      {/* <section className="max-w-7xl mx-auto py-20 px-4">
        <FadeInSection>
          <h2 className="text-3xl text-center md:text-4xl font-bold mb-10 font-montserrat">
            Outdoor Work That <span className="text-primary">Stands Out</span>
          </h2>
          <p className="text-gray-400 text-center mb-16 text-lg font-poppins">
            Check out how we&apos;ve helped brands dominate the streets - with
        ...
        benefits={[
          {
            ...
            description:
              "We place your brand where your audience already is — in neighborhoods, markets, and daily routes.",
          },
          {
            icon: <CheckCircle size={20} />,
            title: "High Visibility, All Day",
            description:
              "From morning commutes to evening traffic — your message stays in sight and on repeat.",
          },
          {
            icon: <CheckCircle size={20} />,
            title: "Design + Execution",
            description:
              "We handle the creative, production, and placement — so you don't have to worry about the details.",
          },
          {
            icon: <CheckCircle size={20} />,
            title: "Scalable for Any Budget",
            description:
              "We offer flexible packages for city-wide impact or targeted local branding.",
          },
        ]}
        featuresRight={[
          "Rickshaw Campaigns",
        ...
        faqs={[
          {
            ...
            answer: (
              <>
                We operate mainly in Karachi but can extend coverage to other
                cities in Pakistan depending on the scale and needs of the
                campaign.
              </>
            ),
          },
          {
            ...
            answer: (
              <>
                Both! Our team handles creative design, print production, and
                the physical placement of all materials.
              </>
            ),
          },
          {
            ...
            answer: (
              <>
                That depends on your budget and objectives. We offer short-term
                (1-2 weeks) and long-term (monthly/quarterly) campaign options.
              </>
            ),
          },
          {
            ...
            answer: (
              <>
                Absolutely. It reaches people in real-time, builds trust through
                repetition, and boosts brand visibility — especially in areas
          ...
          },
          {
            ...
            answer: (
              <>
                100%. Many of our clients combine outdoor visibility with
                digital campaigns for a bigger impact — and we handle both under
                one roof.
              </>
            ),
          },
