        ...
        <div className="px-4">
          <FadeInSection>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-montserrat">
              Give Your Users a Better Experience with <span className="text-primary">UI/UX Design</span> That Just Feels Right
            </h2>
            <p className="text-gray-400 mb-16 max-w-3xl text-lg font-poppins">
              Good design goes beyond aesthetics. It guides users, builds trust, and supports your business goals. At AA Marketing, we design interfaces that are easy to use, easy to love — and hard to forget.
            </p>
          </FadeInSection>
      ...
      {/* <section className="max-w-7xl mx-auto py-20 px-4">
        <FadeInSection>
          <h2 className="text-3xl text-center md:text-4xl font-bold mb-10 font-montserrat">
            Our <span className="text-primary">UI/UX Work</span> in Action
          </h2>
