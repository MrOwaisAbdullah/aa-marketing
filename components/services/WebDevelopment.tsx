        ...
        <div className="px-4">
          <FadeInSection>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-montserrat text-text">
              Websites That <span className="text-primary">Deliver Results</span> — Built by AA Marketing
            </h2>
      ...
      <section className="max-w-7xl mx-auto py-20 px-4">
        <FadeInSection>
          <h2 className="text-3xl text-center md:text-4xl font-bold mb-10 font-montserrat text-text">
            Our <span className="text-primary">Web Projects</span>
          </h2>
          <p className="text-text/80 text-center mb-16 text-lg font-poppins">
            Take a look at some of the websites we&apos;ve helped bring to life — built for performance, usability, and scale.
          </p>
